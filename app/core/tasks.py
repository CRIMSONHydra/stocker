...
Per-step ideal-profit trajectories are precomputed by
scripts/build_ideal_profit.py and dropped into data/ideal_profits/<task_id>.json.
The grader uses these as targets for the performance component.
"""
